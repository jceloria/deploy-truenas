...
Source: https://github.com/jceloria/deploy-truenas
Forked from: https://github.com/danb35/deploy-freenas
"""
...
CERT_DIR_PATH = deploy.get('cert_dir_path', "/root/.acme.sh/" + DOMAIN_NAME)
PRIVATEKEY_PATH = deploy.get('privkey_path', CERT_DIR_PATH + "/" + DOMAIN_NAME + ".key")
FULLCHAIN_PATH = deploy.get('fullchain_path', CERT_DIR_PATH + "/fullchain.cer")
